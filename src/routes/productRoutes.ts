...
import { authorize, authenticateToken } from "../middlewares/auth";
 ...
 *                   type: string
 */
router.put("/:id", authenticateToken as RequestHandler, authorize("admin") as RequestHandler, productController.updateProduct);
